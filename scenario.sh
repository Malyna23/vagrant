...
sudo /usr/bin/php /var/www/html/moodle/admin/cli/install.php --wwwroot=http://192.168.56.2/moodle --dataroot=/var/moodledata --dbtype=mariadb --dbname=dbname --dbuser=mykola --dbpass=123456 --fullname="Moodle" --adminpass=admin  --shortname="Moodle" --non-interactive --agree-license
